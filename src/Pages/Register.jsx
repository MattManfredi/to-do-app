...
const Register = () => {
  ...
  const onSubmit= async(data)=>{
    ...
    try{
      ...
      setAlert({text:'Registro Completado!',redirect:true,duration:2000,path:'/login'})
      setLoading(false)
    }catch(e){
      console.log(e);
    ...
    return (
        <div className="flex mx-auto my-10 justify-evenly items-center w-2/3 bg-transparent backdrop-blur-[2px] py-8 px-8 rounded-2xl shadow-[0_0_56px_23px_rgba(0,0,0,0.83)] border-lightGreen border-2">
